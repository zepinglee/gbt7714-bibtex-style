...
如 \opt{gbt7714-numeric} 或 \opt{gbt7714-authoryear}。
...
\end{latex}
此外还可以使用 2005 版的格式 \file{gbt7714-2005-numeric} 和
\file{gbt7714-2005-authoryear}。
...
\begin{function}{\citestyle}
  ...
  \end{syntax}
可选：\opt{super}, \opt{numbers}, \opt{authoryear}。
